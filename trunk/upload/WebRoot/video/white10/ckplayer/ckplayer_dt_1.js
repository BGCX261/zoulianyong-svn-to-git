/*
JavaScript Document
ckplayer5.2,有问题请访问http://www.ckplayer.com,欢迎把您的风格提供给大家分享
免费软件,请保持本版权信息
*/
function ckstyle(){
	var ck=new Object();
	ck.mylogo='ckplayer/assets_dt_1/logo.swf';//开始加载的logo,如果为空就不加载
	ck.logo='ckplayer/assets_dt_1/cklogo.png,2,100,5';//logo地址,对齐方式(0/1/2/3),x,y,如果不想显示地址设置成空
	ck.buffer='ckplayer/assets_dt_1/buffer.swf';//缓冲图标地址,推荐使用swf
	ck.play_g='ckplayer/assets_dt_1/images_Play_out.png';//播放按钮普通状态图片
	ck.play_m='ckplayer/assets_dt_1/images_Play_on.png';//播放按钮鼠标经过状态图片
	ck.pause_g='ckplayer/assets_dt_1/images_Pause_out.png';//暂停按钮普通状态图片
	ck.pause_m='ckplayer/assets_dt_1/images_Pause_on.png';//暂停按钮鼠标经过状态图片
	ck.pause_c='ckplayer/assets_dt_1/images_Pause_Scgedyke.png';//中间暂停按钮图片
	ck.sound_g='ckplayer/assets_dt_1/images_Sound_out.png';//静音按钮普通状态图片
	ck.sound_m='ckplayer/assets_dt_1/images_Sound_on.png';//静音按钮鼠标经过状态图片
	ck.mute_g='ckplayer/assets_dt_1/images_Mute_out.png';//取消静音按钮普通状态图片
	ck.mute_m='ckplayer/assets_dt_1/images_Mute_on.png';//取消静音按钮鼠标经过状态图片
	ck.full_g='ckplayer/assets_dt_1/images_Full_out.png';//全屏按钮普通状态图片
	ck.full_m='ckplayer/assets_dt_1/images_Full_on.png';//全屏按钮鼠标经过状态图片
	ck.general_g='ckplayer/assets_dt_1/images_General_out.png';//取消全屏按钮普通状态图片
	ck.general_m='ckplayer/assets_dt_1/images_General_on.png';//取消全屏按钮鼠标经过状态图片
	ck.volume_g='ckplayer/assets_dt_1/images_Volume_back.png';//音量调节底部图片
	ck.volume_m='ckplayer/assets_dt_1/images_Volume_on.png';//音量调节亮部图片
	ck.volume_s='ckplayer/assets_dt_1/images_Volume_Float.png';//音量调节按钮图片
	ck.schedule_s='ckplayer/assets_dt_1/images_Schedule.png';//进度调节按钮图片
	ck.bottom_g='ckplayer/assets_dt_1/images_buttom_bg.png';//底部背景图片
	ck.schedule_bg='ckplayer/assets_dt_1/images_Schedule_bg.png';//加载进度背景图片
	ck.schedule_load='ckplayer/assets_dt_1/images_Schedule_load.png';//加载进度图片
	ck.schedule_play='ckplayer/assets_dt_1/images_Schedule_play.png';//播放进度图片
	ck.advmu='ckplayer/assets_dt_1/images_v_off.png';//前置广告静音按钮图片
	ck.advnomu='ckplayer/assets_dt_1/images_v_on.png';//前置广告取消静音按钮图片
	ck.advjump='ckplayer/assets_dt_1/images_adv_skip.png';//前置广告跳过广告图片
	ck.advmclose='ckplayer/assets_dt_1/images_close_adv.png';//关闭滚动广告的按钮
	ck.ctbar='46,30,30,66,2,5000';//底部控制栏的高,左边的距离,右边的距离,下边的距离,隐藏方式(0是不隐藏,1是全屏时隐藏,2是都隐藏),隐藏延迟时间
	ck.play_left=20;//播放/暂停按钮离左边的距离
	ck.clock='0x77808F,70,95,18';//已播放时间/总时间的颜色,宽度,离左边的距离,离上边的距离
	ck.full_right=54;//全屏/取消全屏按钮离右边的距离,至少设置成按钮的宽度
	ck.vol='60,3,112,26,9,9';//音量调节框宽,高,离右边距离,上方距离,滑块的宽,高	
	ck.sound_right=142;//静音/取消静音离右边的距离
	ck.pgb='3,30,28,60,16,9';//进度框的高,离左边距离,离右边距离,离下面距离,滑块的宽,高
	ck.video_bottom=0;//视频区域底部离播放器底部的距离
	ck.re_buttom=0;//底部距离参考值,该值很重要,用来计算如暂停广告,悬浮按钮等的坐标值,正常设置成控制栏或进度调节框离底部的距离
	ck.video_bo='100,1';//视频缓冲时间,是否采用图形优化
	ck.pa='0,90';//浮动暂停按钮是否固定(0,1),透明度|说明：0在有广告时左下角对齐,1表示固定中间
	...
	ck.statustrue=0;//是否跟踪状态-0是关闭,大于0是开启,1是调用普通状态,2增加调用视频信息,3增加调用视频播放过程状态,调用js类ckplayer_status(str),str的参数详细说明参考ckplayer.com
	ck.pr_play='点击播放';
	ck.pr_pause='点击暂停';
	ck.pr_mute='点击静音';
	ck.pr_nomute='取消静音';
