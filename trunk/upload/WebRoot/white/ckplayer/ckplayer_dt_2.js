...
function ckstyle(){
	var ck=new Object();
	ck.mylogo='ckplayer/assets_dt_2/logo.swf';//开始加载的logo,如果为空就不加载
	ck.logo='ckplayer/assets_dt_2/cklogo.png,2,100,5';//logo地址,对齐方式(0/1/2/3),x,y,如果不想显示地址设置成空
	ck.buffer='ckplayer/assets_dt_2/buffer.swf';//缓冲图标地址,推荐使用swf
	ck.play_g='ckplayer/assets_dt_2/images_Play_out.png';//播放按钮普通状态图片
	ck.play_m='ckplayer/assets_dt_2/images_Play_on.png';//播放按钮鼠标经过状态图片
	ck.pause_g='ckplayer/assets_dt_2/images_Pause_out.png';//暂停按钮普通状态图片
	ck.pause_m='ckplayer/assets_dt_2/images_Pause_on.png';//暂停按钮鼠标经过状态图片
	ck.pause_c='ckplayer/assets_dt_2/images_Pause_Scgedyke.png';//中间暂停按钮图片
	ck.sound_g='ckplayer/assets_dt_2/images_Sound_out.png';//静音按钮普通状态图片
	ck.sound_m='ckplayer/assets_dt_2/images_Sound_on.png';//静音按钮鼠标经过状态图片
	ck.mute_g='ckplayer/assets_dt_2/images_Mute_out.png';//取消静音按钮普通状态图片
	ck.mute_m='ckplayer/assets_dt_2/images_Mute_on.png';//取消静音按钮鼠标经过状态图片
	ck.full_g='ckplayer/assets_dt_2/images_Full_out.png';//全屏按钮普通状态图片
	ck.full_m='ckplayer/assets_dt_2/images_Full_on.png';//全屏按钮鼠标经过状态图片
	ck.general_g='ckplayer/assets_dt_2/images_General_out.png';//取消全屏按钮普通状态图片
	ck.general_m='ckplayer/assets_dt_2/images_General_on.png';//取消全屏按钮鼠标经过状态图片
	ck.volume_g='ckplayer/assets_dt_2/images_Volume_back.png';//音量调节底部图片
	ck.volume_m='ckplayer/assets_dt_2/images_Volume_on.png';//音量调节亮部图片
	ck.volume_s='ckplayer/assets_dt_2/images_Volume_Float.png';//音量调节按钮图片
	ck.schedule_s='ckplayer/assets_dt_2/images_Schedule.png';//进度调节按钮图片
	ck.bottom_g='ckplayer/assets_dt_2/images_buttom_bg.png';//底部背景图片
	ck.schedule_bg='ckplayer/assets_dt_2/images_Schedule_bg.png';//加载进度背景图片
	ck.schedule_load='ckplayer/assets_dt_2/images_Schedule_load.png';//加载进度图片
	ck.schedule_play='ckplayer/assets_dt_2/images_Schedule_play.png';//播放进度图片
	ck.advmu='ckplayer/assets_dt_2/images_v_off.png';//前置广告静音按钮图片
	ck.advnomu='ckplayer/assets_dt_2/images_v_on.png';//前置广告取消静音按钮图片
	ck.advjump='ckplayer/assets_dt_2/images_adv_skip.png';//前置广告跳过广告图片
	ck.advmclose='ckplayer/assets_dt_2/images_close_adv.png';//关闭滚动广告的按钮
	ck.ctbar='64,78,77,66,2,5000';//底部控制栏的高,左边的距离,右边的距离,下边的距离,隐藏方式(0是不隐藏,1是全屏时隐藏,2是都隐藏),隐藏延迟时间
	ck.play_left=20;//播放/暂停按钮离左边的距离
	ck.clock='0x77808F,70,80,25';//已播放时间/总时间的颜色,宽度,离左边的距离,离上边的距离
	ck.full_right=77;//全屏/取消全屏按钮离右边的距离,至少设置成按钮的宽度
	ck.vol='60,3,140,38,9,9';//音量调节框宽,高,离右边距离,上方距离,滑块的宽,高	
	ck.sound_right=175;//静音/取消静音离右边的距离
	ck.pgb='3,73,73,50,16,9';//进度框的高,离左边距离,离右边距离,离下面距离,滑块的宽,高
